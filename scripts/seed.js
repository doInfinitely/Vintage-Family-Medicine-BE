...
async function seed() {
  ...
  await insert('call_to_actions', [
    ...
    },
    {
      ...
      href:         'https://maps.google.com/?q=860+Hebron+Parkway+Suite+203+Lewisville+TX+75057',
      opens_new_tab: true,
      is_primary:   false,
      sort_order:   11,
    },
  ...
  const [location] = await insert('locations', [{
    ...
    map_url:        'https://maps.google.com/?q=860+Hebron+Parkway+Suite+203+Lewisville+TX+75057',
    map_embed_url:  'TODO: google maps embed iframe url',
    latitude:       33.0463000,
